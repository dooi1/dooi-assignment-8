...
def do_experiments(start, end, step_num):
    ...
    slopes = [-b1 / b2 for b1, b2 in zip(beta1_list, beta2_list)]
    plt.plot(shift_distances, slopes, marker='o')
    ...
    intercepts = [-b0 / b2 for b0, b2 in zip(beta0_list, beta2_list)]
    plt.plot(shift_distances, intercepts, marker='o')
